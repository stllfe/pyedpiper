...
class ObjectBuilder:
    ...
    @classmethod
    def _get_parameters(cls, obj_type, ignored_parameters=('self',)) -> Dict[str, Union[List, Dict]]:
    ...
    @classmethod
    def build_from_kwargs(cls, obj_type, name=None, **kwargs):
        ...
        try:
            if len(intersection) != len(required_set):
                ...
                message = "Required parameters are: {}".format(', '.join(required_parameters))
